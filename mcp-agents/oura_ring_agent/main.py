...
async def get_daily_oura_biometrics(date: str, user_id: str, diagnosis_mock: str = "") -> list[dict]:
    ...
    """
    records = await _get_daily_oura_biometrics(date, user_id, diagnosis_mock or None)
